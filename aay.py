#Coded By AndreAY ... And Copyright Ofc xD 
#Youtube : AndreAY To Know Some Methods ABout Hacking/Cracking/Crading ....
#Sate !
#Sate !
#Sate !
import random 
...
######## Work ########
def steam() :
 print("""  Steam Generator (c)AndreAY """)
 ...
 try :
   ...
   if so =='y' or so =='Y':
    ...
    exit()
	   	 ...
	   	 pass
def hma() :
 print("""  Hidemyass Generator (c)AndreAY """)
 zz=input('Enter Number Keys > ')
 try :
   for az in range(int(zz)) :
    urname = string.ascii_letters + string.digits
...
def gplay() :
 print("""  Googleplay Generator (c)AndreAY """)
 zz=input('Enter Number Keys > ')
 int(zz)
 try :
   for az in range(int(zz)) :
   ...
   if so =='y' or so =='Y':
        ...
        exit()
	   	 ...
	   	 pass
def express() :
 print("""  Express Vpn Generator (c)AndreAY """)
 zz=input('Enter Number Keys > ')
 try :
   for az in range(int(zz)) :
    urname = string.ascii_letters + string.digits
    urname1 = ''.join(choice(urname) for _ in range(22))
    print(az+1,")","E"+ urname1.upper()," by AAY_ID")
...
def Norton() :
 ...
 try :
   for az in range(int(zz)) :
    ...
    print(az+1,")",'V'+gothar69.upper()," by AAY_ID")
   ...
   if so =='y' or so =='Y':
        ...
        exit()
         ...
         pass
def avgantiv() :
 print("""  AVGAntivurus Generator (c)AndreAY """)
 zz=input('Enter Number Keys > ')
 try :
   for az in range(int(zz)) :
   ...
   if so =='y' or so =='Y':
        ...
        exit()
         ...
         pass
def esetss() :
 print("""  ESet Smart Security Generator (c)AndreAY \n\n  1) Keyz\n  2) Accounts  """)
 psyco = input('$ ')
 if psyco == '1':
  zz=input('Enter Number Keys > ')
  try :
...
def photoshop():
  print(""" PhotoShop Cs6 Genrator (c)AndreAY """)
  zz=input('Enter Number Keys > ')
  try:
    for az in range(int(zz)) :
    ...
    if so =='y' or so =='Y':
        ...
        exit()    
           ...
           pass
def winkeyz():
  print(""" WinDows Genrator (c)AndreAY """)
  zz=input('Enter Number Keys > ')
  try:
    for az in range(int(zz)) :
        meliodas = string.ascii_letters + string.digits
    ...
    if so =='y' or so =='Y':
        ...
        exit() 
           ...
           pass 
def amazon():
 print("""  Amazon Generator (c)AndreAY """)
 zz=input('Enter Number Keys > ')
 try :
  for az in range(int(zz)) :
    urname = string.ascii_letters + string.digits
...
def abo():
 ...
 Name : Andre
 Country : INDONESIA
 Facebook : Fb.com/AndreAY97
 Instagram : @aay_id
 Mail Me : andreandriyanto007@gmail.com
 Github : https://github.com/andreay02
 Youtube : AAY ID """)
 exit()
######## Menu ########
...
#AAY_ID - Key Generator 
#(Updated in May2019) By AndreAY
...
#Without Checker | Check Manually
 ...
 if zack == '1':
    ...
    print("  Go To https://www.andreay.codes/ Or Contact Me")
 elif zack == '69' :
    abo()
 else :
